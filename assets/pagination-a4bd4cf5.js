var G=Object.defineProperty;var z=(t,e,n)=>e in t?G(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var N=(t,e,n)=>(z(t,typeof e!="symbol"?e+"":e,n),n),P=(t,e,n)=>{if(!e.has(t))throw TypeError("Cannot "+n)};var o=(t,e,n)=>(P(t,e,"read from private field"),n?n.call(t):e.get(t)),r=(t,e,n)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,n)},k=(t,e,n,i)=>(P(t,e,"write to private field"),i?i.call(t,n):e.set(t,n),n);import{A as Y,_ as Z}from"./vendor-6fe7236c.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function n(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(a){if(a.ep)return;a.ep=!0;const s=n(a);fetch(a.href,s)}})();var u;class O{constructor(e){r(this,u,void 0);k(this,u,e)}json(){return JSON.parse(o(this,u).data)}info(){return{status:JSON.parse(o(this,u).status),message:JSON.parse(o(this,u).data).message,data:JSON.parse(o(this,u).data)}}}u=new WeakMap;class K{constructor(e){N(this,"axiosInstance");const n={accept:"application/json","content-type":"application/json"};this.axiosInstance=new Y({baseURL:e,headers:{...n}})}async get(e,n){const i=await this.axiosInstance.get(e,n);return new O(i)}async patch(e,n){const i=await this.axiosInstance.patch(e,n);return new O(i)}async post(e,n){const i=await this.axiosInstance.post(e,n);return new O(i)}}var y,l;class tt{constructor(){r(this,y,"https://energyflow.b.goit.study/api/");r(this,l,new K(o(this,y)))}async get(e,n=""){return n?await o(this,l).get(e,n):await o(this,l).get(e)}async patch(e,n=""){return n?await o(this,l).patch(e,n):await o(this,l).patch(e)}async post(e,n=""){return n?await o(this,l).post(e,n):await o(this,l).post(e)}setPathParameters(e,n){let i=e;for(const a in n)i=i.replace(`{${a}}`,n[a]);return i}}y=new WeakMap,l=new WeakMap;var E,S,w,b,L,I;const C=class C extends tt{constructor(){super(...arguments);r(this,E,"filters");r(this,S,"exercises");r(this,w,"exercises/{exerciseID}");r(this,b,"exercises/{exerciseID}/rating");r(this,L,"quote/");r(this,I,"subscription")}async init(){return new C}async getListExercises(n){return await this.get(o(this,E),{params:n})}async getListExercisesBySubspecies(n){return await this.get(o(this,S),{params:n})}async getQuote(){return await this.get(o(this,L))}async getExerciseById(n){return await this.get(this.setPathParameters(o(this,w),{exerciseID:n}))}async addRating(n,i){return await this.patch(this.setPathParameters(o(this,b),{exerciseID:n}),JSON.stringify(i))}async createSubscription(n){return await this.post(o(this,I),JSON.stringify(n))}};E=new WeakMap,S=new WeakMap,w=new WeakMap,b=new WeakMap,L=new WeakMap,I=new WeakMap;let p=C;function xt(t){return t.split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()).join(" ")}function et(t){return t===new Date().setHours(0,0,0,0)}function U(t){return new Date(t).setHours(0,0,0,0)}function Ot(t,e){return Z.chunk(t,e)}const nt=new p,B=nt.init(),d={FAVORITE_EXERCISE:"favorite-exercise",QUOTE:"quote"};function it(t,e=d.FAVORITE_EXERCISE){if(!localStorage.getItem(e))localStorage.setItem(e,JSON.stringify([t]));else{const n=JSON.parse(localStorage.getItem(e));n.push(t),localStorage.setItem(e,JSON.stringify(n))}}function at(t,e=d.FAVORITE_EXERCISE){if(!localStorage.getItem(e))return;let n=R(e);if(n.length>0){let i=n.filter(a=>a._id!==t);localStorage.setItem(e,JSON.stringify(i)),i.length===0&&localStorage.removeItem(e)}}function Tt(t=d.FAVORITE_EXERCISE){return R(t)}function J(t,e=d.FAVORITE_EXERCISE){if(!localStorage.getItem(e))return!1;let n=R(e);return n.length>0?n.filter(a=>a._id===t).length>0:!1}async function st(){const t=(await(await B).getQuote()).json();t.timeStamp=U(new Date),localStorage.setItem(d.QUOTE,JSON.stringify(t))}async function Q(){if(!localStorage.getItem(d.QUOTE))await st();else{const t=JSON.parse(localStorage.getItem(d.QUOTE)).timeStamp;if(!et(t)){const i=(await(await B).getQuote()).json();i.timeStamp=U(new Date),localStorage.setItem(d.QUOTE,JSON.stringify(i))}const{author:e,quote:n}=JSON.parse(localStorage.getItem(d.QUOTE));return{author:e,quote:n}}}function R(t){try{return JSON.parse(localStorage.getItem(t))}catch{console.error("Parsing Error")}}function ot(t){gt(),rt(t)}function rt(t){ut.dataset.exerciseId=t}const D=document.querySelector(".js-modal"),ct=document.querySelector(".js-close"),lt=document.querySelector(".mrating"),dt=document.querySelector(".rating-form"),ut=document.querySelector(".js-sbutton"),mt=document.querySelector(".message");function gt(){D.classList.add("is-open")}function F(){D.classList.remove("is-open")}ct.addEventListener("click",F);let V,_;pt(lt);function pt(t){T(t),m(),t.classList.contains("rating-set")&&ft(t)}function T(t){V=t.querySelector(".mrating-active"),_=t.querySelector(".mrating-value")}function m(t=_.innerHTML){const e=t/.05;V.style.width=`${e}%`}function ft(t){const e=t.querySelectorAll(".mrating-item");for(let n=0;n<e.length;n+=1){const i=e[n];i.addEventListener("mouseenter",function(a){T(t),m(i.value)}),i.addEventListener("mouseleave",function(a){m()}),i.addEventListener("click",function(a){T(t);const s=n+1;_.innerHTML=s,m()})}}let vt=new p;dt.addEventListener("click",ht);async function ht(t){if(t.preventDefault(),!t.target.tagName!=="BUTTON"&&t.target.tagName==="BUTTON"){if(+t.currentTarget.children[0].innerText.trim()<=0)return;const e=t.currentTarget.elements.ratbtn.dataset.exerciseId,n={};n.rate=+t.currentTarget.children[0].innerText.trim(),n.email=t.currentTarget.elements.email.value,n.review=t.currentTarget.elements.comment.value;try{const i=await vt.addRating(e,n),a=i.info();a.status===200?(F(),yt(i.json())):mt.textContent=a.message}catch(i){console.error(i)}}}const A=document.body,f=document.querySelector(".backdrop"),M=document.querySelector(".js-modal-container");document.querySelector(".close-btn");let g;function yt(t){g=t,t._id,f.classList.add("is-open"),A.style.overflow="hidden",window.addEventListener("keydown",v),window.addEventListener("click",h);let e;J(t._id)?e=`
