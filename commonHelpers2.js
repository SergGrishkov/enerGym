import{E as M,f as A}from"./assets/quote-0359a058.js";import"./assets/vendor-0fffa566.js";const h=document.querySelector(".backdrop"),y=document.querySelector(".js-modal-container");document.querySelector(".close-btn");let D="64f389465ae26083f39b17a9",w="",c={},N=new M;async function B(e){return w=e,await(await N.getExerciseById(w)).json()}async function O(e){try{const t=await B(e),i=y.querySelector(".js-add-remove-btn");let n="",o="",s;t&&I(t,C())?s=`
