import{E as T,f as k}from"./assets/quote-1ee34b50.js";import"./assets/vendor-0fffa566.js";const q=document.querySelector(".backdrop"),p=document.querySelector(".js-modal-container");document.querySelector(".close-btn");let _="64f389465ae26083f39b17a9",v="",o={},j=new T;async function M(e){return v=e,await(await j.getExerciseById(v)).json()}async function W(e){try{const i=await M(e),t=p.querySelector(".js-add-remove-btn");let s="",n="";i&&F(i,C())?(s="./img/sprite/sprite.svg#icon-remove-favorites",n="Remove from favorites"):(s="./img/sprite/sprite.svg#icon-add-favorites",n="Add to favorites"),p.innerHTML=`<div
