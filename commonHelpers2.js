import{E as M,f as q}from"./assets/quote-da90f686.js";import"./assets/vendor-0fffa566.js";const h=document.querySelector(".backdrop"),y=document.querySelector(".js-modal-container");document.querySelector(".close-btn");let W="64f389465ae26083f39b17a9",w="",a={},D=new M;async function A(e){return w=e,await(await D.getExerciseById(w)).json()}async function N(e){try{const t=await A(e),i=y.querySelector(".js-add-remove-btn");let n="",s="",o;t&&C(t,B())?o=`
