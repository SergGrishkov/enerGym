import{E as y,f as E,g as w}from"./assets/favorites-main-b1823de8.js";import"./assets/vendor-0fffa566.js";const g=document.querySelector(".backdrop"),n=document.querySelector(".js-modal-container");document.querySelector(".close-btn");let L="64f389465ae26083f39b17a4",l="",o={},$=new y;async function m(e){return l=e,await(await $.getExerciseById(l)).json()}async function q(e){try{const t=await m(e),s=n.querySelector(".js-add-remove-btn");let i="",r="";t&&h(t,v())?(i="./img/sprite/sprite.svg#icon-remove-favorites",r="Remove from favorites"):(i="./img/sprite/sprite.svg#icon-add-favorites",r="Add to favorites"),n.innerHTML=`<div
