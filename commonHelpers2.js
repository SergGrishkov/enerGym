import{E as M,f as A}from"./assets/quote-0cc0ad91.js";import"./assets/vendor-0fffa566.js";const h=document.querySelector(".backdrop"),y=document.querySelector(".js-modal-container");document.querySelector(".close-btn");let D="64f389465ae26083f39b17a9",w="",a={},N=new M;async function B(e){return w=e,await(await N.getExerciseById(w)).json()}async function O(e){try{const t=await B(e),i=y.querySelector(".js-add-remove-btn");let n="",o="",s;t&&I(t,C())?s=`
    ...
    </li>`,"")}document.addEventListener("DOMContentLoaded",fe);L.addEventListener("click",e=>_(e,"filter"));b.addEventListener("click",ye);u.addEventListener("click",e=>be(e));const x=document.querySelector(".back-to-top");x.addEventListener("click",we);window.onscroll=()=>{xe()};function we(){window.scrollTo({top:0,behavior:"smooth"})}function xe(){document.body.scrollTop>20||document.documentElement.scrollTop>20?x.classList.remove("is-hidden"):x.classList.add("is-hidden")}const Ee=document.querySelector(".icon-about-sport");let q=0;function Le(){q+=1,Ee.style.transform=`rotate(${q}deg)`}setInterval(Le,10);
